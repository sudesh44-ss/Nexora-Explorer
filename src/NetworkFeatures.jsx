            ...
            {activeTab === "discovery" && (
              <div className="network-page">
                ...
                {localInterfaces.length > 0 && (
                  <div className="network-section-card" style={{ marginBottom: "15px", padding: "12px" }}>
                    ...
                    <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px", fontSize: "11px" }}>
                      {localInterfaces.map((iface, i) => (
                        <div key={i} style={{ backgroundColor: "#f9fafb", padding: "8px", borderRadius: "4px" }}>
                          <span>Name: <strong>{iface.interface}</strong></span><br />
                          <span>IP: <strong>{iface.ip}</strong></span><br />
                          <span>Netmask: <strong>{iface.netmask}</strong></span>
                        </div>
                      ))}
                    </div>
                  </div>
